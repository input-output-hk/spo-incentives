...
# Run from: spo-incentives/delegators/dbsync/
#
#   cd spo-incentives/delegators/dbsync && bash run.sh
# ============================================================================
...
echo ""
echo "Once synced, dump delegation data:"
echo "  cd $(dirname "$DBSYNC_DIR")/.."
echo "  export DBSYNC_CONN_STR='postgresql://postgres:delegator-analysis-2026@localhost:5433/cexplorer'"
echo "  python3 spo-incentives/delegators/scripts/ingest_dbsync.py"
echo "  python3 spo-incentives/delegators/scripts/ingest_to_duckdb.py --source dbsync"
echo ""
echo "Timeline:"
