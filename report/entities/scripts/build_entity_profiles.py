...
OD_DATA = ROOT.parent / "sub-flows" / "operator-delegator-distribution" / "mainnet-analysis" / "data"
PD_DATA = ROOT.parent / "sub-flows" / "pools-distribution" / "mainnet-analysis" / "data"
OUT = ROOT / "data"
...
def main():
    ...
    arch_path = PD_DATA / "mpo_entity_archetypes.csv"
    if arch_path.exists():
