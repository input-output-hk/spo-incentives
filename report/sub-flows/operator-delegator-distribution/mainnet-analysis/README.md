...
4. **The delegator yield** (§5). The yield trajectory (5.3% → 2.0% in 5.5 years), cross-chain and cross-asset comparison, and the structural compression that makes the yield spread too narrow to drive delegation decisions — and will make it narrower still as the reserve depletes.
...
| F1.1 | The flat fee accounts for 60% of all operator revenue in the retail market; the commission accounts for 40% | [§4.2.3](../../../README.md#423-maintain-and-diversify-a-competitive-delegator-yield) | Structural — the passive channel dominates the active one |
| F1.2 | 64% of pools still declare the former floor (340 ₳) — 178 epochs after a governance action halved it to 170 ₳ | [§4.1](../../../README.md#41-constitutional-framework) | Governance inertia — driven by the largest entities |
| F1.3 | 89.5% of pools declare one of two floor values (170 or 340 ₳); "custom" values are mostly near-floor inertia (Binance 345, Everstake 400) or extraction | [§4.1](../../../README.md#41-constitutional-framework) | The flat fee is a binary choice, not a pricing parameter |
| F1.4 | The flat fee follows a $1/\sigma$ hyperbola: 47.5% of pool reward at the sub-viable tier, 1.5% at near-saturation. No other major PoS protocol uses a flat fee | [§4.1](../../../README.md#41-constitutional-framework) | Unique to Cardano — regressive by design |
| | **O2 — The commission market is bimodal with an empty middle** | | |
| F2.1 | 87% of pools set a commission at or below 10%; 12% set ≥ 99% (privatisation). The 89pp range between 10% and 99% contains 12 pools | [§4.2.1](../../../README.md#421-guarantee-operator-viability-across-the-entire-productive-population) | No man's land — no economic attractor exists between pricing and extraction |
| F2.2 | Four bands: no-commission (170 pools, 17.9%), competitive (658, 69.1%), no man's land (12, 1.3%), privatisation (112, 11.8%) | [§4.2.1](../../../README.md#421-guarantee-operator-viability-across-the-entire-productive-population) | The market self-organises into discrete tiers |
| | **O3 — 21% of productive stake is custodial — three mechanisms, three economics** | | |
| F3.1 | 79 entities operating 143 pools (4.55B, 21.1%) are custodial: by pledge (10 entities, 36 pools, 1.59B), by extraction (57 entities, 79 pools, 2.04B), by delegation (15 entities, 28 pools, 0.92B) | [§4.2.2](../../../README.md#422-restore-the-notion-of-pledge-among-operators) | Three distinct mechanisms — each detectable from on-chain observables |
| F3.2 | Custodial-by-delegation uses the per-pool **median** delegation (db-sync `epoch_stake`) ≥ 100K ₳ — the amount held by the typical delegator. A delegation of 50K ₳ is already in the top 1.5% of the network | [§4.2.2.2](../../../README.md#4222-specification) | The median measures the delegator's experience, not capital concentration |
| F3.3 | Custodial-by-pledge entities earn 1,759,252 ₳/yr median — they capture 100% of rewards on self-funded pools. Custodial-by-extraction entities earn 281,831 ₳/yr — privatisation commission on pools with inert delegators. Custodial-by-delegation entities earn 29,329 ₳/yr — small whale pools, not revenue machines | [§4.3.3](#433-summary) | Each custodial mechanism produces a different economic outcome |
| | **O4 — The retail market is 79% of stake and the typical delegator holds 87 ₳** | | |
| F4.1 | 809 retail pools, 516 entities, 17.02B ADA, 1,272,836 delegators. This includes institutional operators (Coinbase, Binance, Kiln) — retail by median delegation | [§4.3.3](#433-summary) | The retail market is larger than the mean-based estimate suggested |
| F4.2 | The median retail delegation is 87 ₳ — remarkably uniform across operator types (45–962 ₳ range) | [§4.2.3](../../../README.md#423-maintain-and-diversify-a-competitive-delegator-yield) | Retail delegators are small and homogeneous |
| | **O5 — Delegators pay 18× more for the same return** | | |
| F5.1 | A delegator in a sub-viable pool pays 48.3% effective price and receives 2.04% net return. A delegator in a near-saturation pool pays 2.7% and receives 2.34%. 18× more for 0.30pp of return | [§4.2.3](../../../README.md#423-maintain-and-diversify-a-competitive-delegator-yield) | The effective price is a mechanical artefact of pool size, not a market signal |
| F5.2 | Net return converges to 1.95–2.34% across the entire retail market regardless of effective price, operator type, or pool size | [§4.2.3](../../../README.md#423-maintain-and-diversify-a-competitive-delegator-yield) | The return signal is too weak to drive delegation |
| | **O6 — Stake pool operator profitability ranges from 24K to 1M ₳/yr — operators who charge the most earn the least** | | |
| F6.1 | A sub-viable single-pool operator absorbs 48.3% of pool rewards but earns 24,820 ₳/yr. An 11+ pool MPO absorbs 7.7% but earns 1,035,496 ₳/yr — 42× more at 6× less effective price | [§4.2.3](../../../README.md#423-maintain-and-diversify-a-competitive-delegator-yield) | The flat fee penalises small-pool delegators without compensating small-pool operators |
| F6.2 | MPO revenue scales horizontally (more pools) not vertically (higher price). The 11+ pool bracket captures 26.5% of retail rewards through 7 entities | [§4.2.3](../../../README.md#423-maintain-and-diversify-a-competitive-delegator-yield) | Fleet size, not pricing, drives operator economics |
| F6.3 | 57 hollow MPOs operate on 64.4% of retail rewards; 414 hollow single-pool operators share 31.1%; 41 balanced operators share 1.2% | [§4.2.3](../../../README.md#423-maintain-and-diversify-a-competitive-delegator-yield) | Structural concentration |
| F6.4 | No single-pool operator in the retail market earns a competitive wage for their labour. The median single-pool revenue of ~25,000 ₳/yr ($6,250 at $0.25/ADA) covers infrastructure but not the 5–15 hrs/month of skilled work. Competitive compensation begins at the 2-pool MPO tier (~68,700 ₳/yr) | [§4.2.4](../../../README.md#424-reduce-the-concentration-effects-that-distort-both-populations) | The single-pool operator subsidises the network |
| | **O7 — Delegation follows visibility, not return** | | |
| F7.1 | 65.9% of retail delegators sit in hollow MPO pools at 2.18% net return; hollow single-pool near-saturation pools offer 2.34% — 0.16pp more — and hold 2.7% of delegators | [§4.2.3](../../../README.md#423-maintain-and-diversify-a-competitive-delegator-yield) | The return signal does not drive delegation |
| F7.2 | The pledge premium is negative in the retail data: balanced median net return 1.98% vs hollow 2.08%. The flat fee drag (1.06pp for balanced vs 0.47pp for hollow single-pool operators) overwhelms the pledge benefit | [§4.2.3](../../../README.md#423-maintain-and-diversify-a-competitive-delegator-yield) | The incentive mechanism's core assumption fails |
| | **O8 — The mechanism is on a structural clock: reserve depletion compresses yield, widens the confiscatory zone, and erodes the signal every epoch** | | |
| F8.1 | The delegator yield has fallen from 5.3% to 2.0% in 413 epochs (5.5 years), tracking reserve depletion with $R^2 = 0.99$. Projection: sub-1.5% within ~1.7 years, sub-1.0% within ~3.5 years. The decline is irreversible without protocol-level intervention — it is built into the monetary expansion formula | [§5.1](#51-the-yield-trajectory-level-and-decline) | The entire yield surface descends as a unit; no pool-level strategy can offset the macro trajectory |
| F8.2 | At 2.0%, Cardano sits below the USD risk-free rate (4.3%) and at the bottom of the PoS landscape. No other major chain combines this low a yield with liquid, non-custodial, slashing-free design. The low return is the cost of that design — delegation is a conviction bet on ADA, not a yield-seeking decision | [§5.2](#52-the-yield-in-context-cross-chain-and-cross-asset-comparison) | The mechanism assumes yield-sensitive delegators, but the yield regime no longer supports that assumption |
| F8.3 | As the epoch pot shrinks, the flat fee (fixed at 170/340 ₳) consumes a growing share of pool rewards — the confiscatory zone identified in [§4.1](../../../README.md#41-constitutional-framework) expands upward. The 0.39pp retail yield spread compresses proportionally: at 1.0% base yield (~3.5 years), the same relative dispersion produces ~0.20pp — indistinguishable from block-production noise. Pools that are viable today will cross the sub-viable threshold | [§5.3](#53-the-yield-spread-structural-compression) | The failures documented in §4 are not static — they degrade every epoch |
| F8.4 | The declining yield acts as a selection ratchet against small independent operators. The flat fee is fixed in absolute terms while the epoch pot shrinks — the confiscatory zone expands upward every epoch. Single-pool operators bear the full drag with no fleet to amortise it; multi-pool operators are insulated by horizontal scaling. The structural feedback loop (yield compression → confiscatory expansion → single-pool attrition → delegation migration → fleet concentration) drives the centralisation the mechanism was designed to prevent | [§5.3](#53-the-yield-spread-structural-compression) | The mechanism selects against its smallest operators and reinforces its largest |

**Scope note.** O1 describes the flat fee channel ([§4.1](../../../README.md#41-constitutional-framework)). O2 describes the commission channel ([§4.2.1](../../../README.md#421-guarantee-operator-viability-across-the-entire-productive-population)). O3 establishes the custodial/retail boundary and custodial economics ([§4.2.2](../../../README.md#422-restore-the-notion-of-pledge-among-operators)). O4–O6 characterise the retail market economics and operator viability ([§4.2.3](../../../README.md#423-maintain-and-diversify-a-competitive-delegator-yield)–4.5). O7 addresses delegation behaviour ([§4.2.3](../../../README.md#423-maintain-and-diversify-a-competitive-delegator-yield)). O8 places the mechanism on its temporal trajectory: the yield decline is not a separate problem — it amplifies every structural failure documented in §4 (§5).
...
67,817 delegations (5.2% of productive) sit in sub-viable pools where the flat fee's regressive geometry erodes most or all delegator returns — 92% of those land in independent single-pool operators. The **1,227,281 delegations** in viable pools are where the pricing plan produces meaningful outcomes. The downstream analysis ([§4.2.2](../../../README.md#422-restore-the-notion-of-pledge-among-operators)) decomposes the productive population into operator self-stake, custodial, and retail segments.
...
Not all staked ADA is delegated by independent participants choosing a pool on the open market. A significant share is **custodial** — controlled by operators rather than by the on-chain delegators themselves. Identifying these pools is necessary before the profitability analysis ([§4.2.3](../../../README.md#423-maintain-and-diversify-a-competitive-delegator-yield)) can isolate the genuine pricing market.
...
[§4.2.3](../../../README.md#423-maintain-and-diversify-a-competitive-delegator-yield) quantifies what operators earn; this section asks whether those earnings are *competitive* — whether they compensate for the real resources consumed. A reward mechanism that underpays its operators relative to their costs and opportunity cost will eventually lose them. A mechanism that overpays has room to optimise. The question is where Cardano's operator economics sit on that spectrum.
...
Infrastructure and labour are denominated in fiat; operator revenue is denominated in ADA. The economic viability of pool operation is therefore a function of two variables: the ₳ revenue (set by the mechanism) and the ADA/USD exchange rate (set by the market). The [§4.2.3](../../../README.md#423-maintain-and-diversify-a-competitive-delegator-yield) revenue data maps directly onto this cost framework. The table below holds the first constant — each tier's median ₳/yr from [§4.2.3](../../../README.md#423-maintain-and-diversify-a-competitive-delegator-yield) — and varies the second across five price points spanning a 40× range.
...
> **Finding F8.1 — The yield has fallen from 5.3% to 2.0% in 413 epochs, tracking reserve depletion with $R^2 = 0.99$.** Projection: sub-1.5% within ~1.7 years, sub-1.0% within ~3.5 years. The decline is irreversible without protocol-level intervention — it is built into the monetary expansion formula. No pool-level strategy can offset the macro trajectory.
...
[§5.3](#53-the-yield-spread-structural-compression) takes this framework to the intra-pool level: given that the absolute yield is modest and declining, is the *spread* between pools wide enough to drive delegation decisions?

![Cardano's Staking Yield in Context — Cross-Chain and Cross-Asset Comparison](figures/yield_cross_chain_comparison.png)

> **Finding F8.2 — At 2.0%, Cardano sits below the USD risk-free rate (4.3%) and at the bottom of the PoS landscape.** No other major chain combines this low a yield with liquid, non-custodial, slashing-free design. The low return is the cost of that design — delegation is a conviction bet on ADA, not a yield-seeking decision. The mechanism assumes yield-sensitive delegators, but the yield regime no longer supports that assumption.

### 5.3 The yield spread — structural compression

The more important question for the delegator is not the absolute level but the *spread* — how much yield varies across the pools available for delegation. [§4.2.3](../../../README.md#423-maintain-and-diversify-a-competitive-delegator-yield) established that net ROS ranges from 1.95% to 2.34% across the entire retail market — a 0.39 percentage-point spread. This section places that spread in the context of the declining trajectory.

The spread is narrow because the reward curve distributes rewards roughly proportional to stake. The flat fee hyperbola penalises only small pools ([§4.1](../../../README.md#41-constitutional-framework)); commission competition has compressed fees in the large-pool regime ([§4.2.1](../../../README.md#421-guarantee-operator-viability-across-the-entire-productive-population)); block production is proportional to stake; and the single-pool/MPO distinction has no net yield effect ([§4.2.3](../../../README.md#423-maintain-and-diversify-a-competitive-delegator-yield)). The only pools that offer materially different returns are those the delegator should avoid: sub-viable pools (median 2.04%, but 48.3% effective price), oversaturated pools (0.5–0.9pp penalty), and dead pools that extract 100% of rewards.
