...
- **If the migration does not happen, the reforms invert their intent.** Without the redistribution, fee-layer tightening produces the opposite outcome of what the CIPs target:
  - **Fragilises the small-operator population** — Sub-reliable operator revenue cut **–9×** under the Margin swap alternative (cip-0082.md §3.1.F2), while remaining below the ~28 600 ₳/yr cost floor (OPE.O6.F4).
  - **Amplifies n-MPO concentration** — the transfer compounds with fleet size: **+200 K ₳/yr** per 11+ pool MPO entity vs **–11 K ₳/yr** per sub-reliable single-pool operator (cip-0082.md §3.1.F3). More pools per entity = larger capture of the reform's upside.
