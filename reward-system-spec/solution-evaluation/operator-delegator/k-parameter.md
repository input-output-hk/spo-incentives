...
| k-lever.S3.F1 | [R] | Historical `k: 150 → 500` (Aug 2020) produced the MPO fleet landscape POL.O5.F1 documents today (85 entities control 75.4 % of participating stake across 901 pools) | §3.3 |
...
| **POL.O5.F3 — 41 of 48 saturation-scale MPOs are non-compliant**, forfeiting ~550 K ADA/epoch (~40.2 M ₳/yr) in pledge bonus rather than locking capital | Among the population that *could* play the pledge game (has enough capital), 85 % choose not to. The amplified bonus from a k-raise does not change the opportunity-cost calculus enough to flip this choice | — |
| **POL.O5.F1 — 85 MPO entities operate 901 pools holding 16.4 B ₳ (75.4 % of participating stake)** | Three quarters of the network's stake is controlled by multi-pool operators who could absorb new slots created by a k-raise at ~500 ADA registration cost each | POL.O5.F2 (MPO saturation-scale split — 48 entities could self-pledge ≥ 1 pool) |
...
| 3. Operators self-pledge more | **Not supported** — POL.O2.F2: pledge yield (0.68 %/yr) is structurally below passive-delegation yield (2.3 %/yr). POL.O5.F3: 41 of 48 saturation-scale MPOs already forfeit the bonus. Amplifying a dominated reward does not flip the opportunity cost |
