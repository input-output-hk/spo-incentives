...
- **Stake concentration bypasses the anti-Sybil mechanics at the entity level** — 83 attributed entities operating 475 productive pools today control 75.5 % of productive stake; multi-pool operators capture a majority, the very pattern the formula's pledge term was meant to discourage.
...
| Sub-aspect | CIP-0023 | CIP-0082 stage 2 | CIP-0082 stages 3–4 | CIP-0050 | CIP-0037 |
|---|:---:|:---:|:---:|:---:|:---:|
| [Operator side — multi-pool entity concentration](../README.md#3411-the-operator-side-multi-pool-entity-concentration) | · | · | ▼ 2020 `k:150→500` precedent: MPO fleet absorption (83 entities, 75.5 % productive stake, 475 productive pools today) | ● revenue-neutral pool-splitting at the pool level | ○ slope penalises split; 20 % floor undoes it for sub-floor splits |
