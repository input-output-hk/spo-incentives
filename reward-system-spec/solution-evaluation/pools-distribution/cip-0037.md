...
*C37.2.1 — CIP-0037 saturation curve at reference parameters: **floor at 13.49 M ADA** (20 % of $z_0$) below 108 k pledge, linear slope through the mid-range, **ceiling at 67.44 M ADA** above ~540 k pledge.*
...
*C37.2.2 — Side-by-side of CIP-0037 vs CIP-0050: at matched leverage ($\ell = L = 125$, panel b), the **20 % floor** is the sole structural difference — the slope and ceiling are identical.*
...
| Retail zero-pledge (pledge below floor-exit threshold) | ~94 % × 17 B ≈ 16.0 B ₳ | Floor | **Clipped** — the clip fraction depends on σ: pools below 13.5 M unaffected; Healthy-tier pools above ~13.5 M lose 10 % or more; Large-healthy+ lose 73 % or more |
