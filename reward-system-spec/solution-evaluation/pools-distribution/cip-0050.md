...
- **V2 Roadmap milestones potentially affected:** [V2 Roadmap M1 — Repair pledge, sustain the small SPO base](../../README.md#21-milestone-1-repair-pledge-sustain-the-small-spo-base) (the four-move repair this CIP would interact with) ; [V2 Roadmap §2.5 — Research axis on concentration](../../README.md#25-research-axis-reduce-the-concentration-effects-that-distort-both-populations) (the entity-level work CIP-0050's pledge-leverage cap engages indirectly).
