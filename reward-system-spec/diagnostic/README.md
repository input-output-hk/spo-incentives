...
| **POL.O5** | **85 multi-pool operators control 75% of staked supply** | 85 MPO entities operate 901 pools holding 16.4B ADA (75.4% of participating stake). 48 saturation-scale MPOs could play the pledge game; 37 cannot. Of the 48, 41 are non-compliant — forfeiting ~550K ADA/epoch in pledge bonus. CEX + IVaaS alone hold 7.4B ADA (19.2% of supply) at structurally zero pledge. 3 exemplary MPOs capture 82% of bonus ADA among pledging entities — the mechanism's output rests on 2 private entities. |
...
The visible damage is consistent with this diagnosis: **95.6% of the pledge-bonus budget returns to reserve unused** (POL.O1), the independent operator base has collapsed to **283 viable operators** once MPO fleets are removed (POL.O6), and structural populations totalling **7.4B ADA cannot pledge by architectural constraint** (POL.O5) — the dominant capital pool sits outside the incentive arena entirely.
...
- **community and opaque MPO fleets** (41 of 48 saturation-scale entities) who have *chosen* not to pledge despite the capacity — the rational response to the pledge-value inversion documented in [The inversion](#12436-the-inversion)
