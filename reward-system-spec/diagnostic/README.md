...
| # | Observation | Summary |
| --- | --- | --- |
| **TRE.O1** | **The epoch pot rests on a single source — and that source has crossed its half-life** | Monetary expansion provides ~99.8% of the pot. Fees cover ~0.19%; self-sufficiency would require 12–16× current capacity. Block production is reliable (η ≈ 0.977). |
