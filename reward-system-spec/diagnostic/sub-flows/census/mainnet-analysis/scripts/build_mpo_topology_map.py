...
<div id="panel">
  ...
  <div class="section" style="flex:1; min-height: 200px;">
    <h2>Entities in view <span class="sublabel">click to fly to</span></h2>
    <input id="searchBox" type="text" placeholder="Search entity / ticker..." autocomplete="off"/>
    <div id="entityPanel" style="margin-top:8px"></div>
  </div>
