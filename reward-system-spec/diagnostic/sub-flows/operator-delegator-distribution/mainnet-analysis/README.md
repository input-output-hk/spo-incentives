...
The remainder of the report walks the analysis in four parts: [the formula](#2-the-formula-intra-pool-reward-sharing) presents the SL-D1 split rule in three layers (original notation → residual-split decomposition → reader-friendly rewrite → mainnet parameterisation); [the productive and viable populations](#3-the-productive-and-viable-populations) traces the operator and delegator sides from raw certificates to the viable threshold; [the pricing plan landscape](#4-the-pricing-plan-landscape) analyses the flat fee, commission, custodial/retail boundary, operator profitability, and delegator return; [the delegator yield](#5-the-delegator-yield-trajectory-context-and-structural-compression) traces the trajectory, cross-chain comparison, and structural compression. All counts and amounts use epoch **623**. Source data: `pool_choice_quality_623.csv`, `pool_median_delegation_623.csv` (db-sync `epoch_stake`), `reward_split_snapshot_623.csv` (synthetic, estimated from epoch 614 reward rate), `koios_pool_history_mainnet.csv`, `mpo_entity_pool_mapping_mainnet.csv`.
...
| OPE.O1.F1 | The flat fee accounts for **60%** of all operator revenue in the retail market; the commission accounts for **40%** | [Maintain and diversify a competitive delegator yield](../../../../README.md#33-maintain-and-diversify-a-competitive-delegator-yield) | Structural — the passive channel dominates the active one |
| OPE.O1.F2 | **64%** of pools still declare the former floor (**340 ₳**) — **178 epochs** after a governance action halved it to **170 ₳** | [Constitutional framework](../../../../README.md#2-constitutional-framework) | Governance inertia — driven by the largest entities |
| OPE.O1.F3 | **89.5%** of pools declare one of two floor values (**170** or **340 ₳**); "custom" values are mostly near-floor inertia (Binance 345, Everstake 400) or extraction | [Constitutional framework](../../../../README.md#2-constitutional-framework) | The flat fee is a binary choice, not a pricing parameter |
| OPE.O1.F4 | The flat fee follows a $1/\sigma$ hyperbola: **47.5%** of pool reward at the sub-viable tier, **1.5%** at near-saturation | [Constitutional framework](../../../../README.md#2-constitutional-framework) | Regressive by design — a fixed-in-₳ levy on a size-proportional reward |
| OPE.O1.F5 | **No other major PoS protocol uses a flat fee.** The fixed-cost model is unique to Cardano; Ethereum, Solana, Cosmos, and Polkadot all price validators on proportional rules | [Constitutional framework](../../../../README.md#2-constitutional-framework) | Unique to Cardano — no cross-chain precedent or comparator |
...
| OPE.O2.F1 | 87% of pools set a commission at or below 10%; 12% set ≥ 99% (privatisation). The 89pp range between 10% and 99% contains 12 pools | [Guarantee operator viability across the entire productive population](../../../../README.md#31-guarantee-operator-viability-across-the-entire-productive-population) | No man's land — no economic attractor exists between pricing and extraction |
| OPE.O2.F2 | Four bands: no-commission (170 pools, 17.9%), competitive (658, 69.1%), no man's land (12, 1.3%), privatisation (112, 11.8%) | [Guarantee operator viability across the entire productive population](../../../../README.md#31-guarantee-operator-viability-across-the-entire-productive-population) | The market self-organises into discrete tiers |
...
| OPE.O3.F1 | 79 entities operating 143 pools (4.55B, 21.1%) are custodial: by pledge (10 entities, 36 pools, 1.59B), by extraction (57 entities, 79 pools, 2.04B), by delegation (15 entities, 28 pools, 0.92B) | [Restore the notion of pledge among operators](../../../../README.md#32-restore-the-notion-of-pledge-among-operators) | Three distinct mechanisms — each detectable from on-chain observables |
| OPE.O3.F2 | Custodial-by-delegation uses the per-pool **median** delegation (db-sync `epoch_stake`) ≥ 100K ₳ — the amount held by the typical delegator. A delegation of 50K ₳ is already in the top 1.5% of the network | [Specification](../../../../README.md#322-specification) | The median measures the delegator's experience, not capital concentration |
| OPE.O3.F3 | Custodial-by-pledge entities earn 1,759,252 ₳/yr median — they capture 100% of rewards on self-funded pools. Custodial-by-extraction entities earn 281,831 ₳/yr — privatisation commission on pools with inert delegators. Custodial-by-delegation entities earn 29,329 ₳/yr — small whale pools, not revenue machines | [Summary](#433-summary) | Each custodial mechanism produces a different economic outcome |
...
| OPE.O4.F1 | 809 retail pools, 516 entities, 17.02B ADA, 1,272,836 delegators. This includes institutional operators (Coinbase, Binance, Kiln) — retail by median delegation | [Summary](#433-summary) | The retail market is larger than the mean-based estimate suggested |
| OPE.O4.F2 | The median retail delegation is 87 ₳ — remarkably uniform across operator types (45–962 ₳ range) | [Maintain and diversify a competitive delegator yield](../../../../README.md#33-maintain-and-diversify-a-competitive-delegator-yield) | Retail delegators are small and homogeneous |
| | **OPE.O5 — Delegators pay 18× more for the same return** | | A sub-viable delegator pays **48.3%** effective price for **2.04%** net return; a near-saturation delegator pays **2.7%** for **2.34%** — **18× the price for 0.30 percentage points** of extra yield. Net return converges to **1.95–2.34%** across the entire retail market — a signal too narrow to discipline pricing. |
| OPE.O5.F1 | A delegator in a sub-viable pool pays 48.3% effective price and receives 2.04% net return. A delegator in a near-saturation pool pays 2.7% and receives 2.34%. 18× more for 0.30pp of return | [Maintain and diversify a competitive delegator yield](../../../../README.md#33-maintain-and-diversify-a-competitive-delegator-yield) | The effective price is a mechanical artefact of pool size, not a market signal |
| OPE.O5.F2 | Net return converges to 1.95–2.34% across the entire retail market regardless of effective price, operator type, or pool size | [Maintain and diversify a competitive delegator yield](../../../../README.md#33-maintain-and-diversify-a-competitive-delegator-yield) | The return signal is too weak to drive delegation |
| | **OPE.O6 — Stake pool operator profitability ranges from 24K to 1M ₳/yr — operators who charge the most earn the least** | | Operator revenue scales with fleet size, not price — the sub-viable single-pool operator absorbs **48.3%** of pool rewards for **24,820 ₳/yr**, while an 11+ pool MPO absorbs **7.7%** for **1,035,496 ₳/yr** (**42× more revenue at 6× less price**). No single-pool operator in the retail market earns a competitive wage. |
| OPE.O6.F1 | A sub-viable single-pool operator absorbs 48.3% of pool rewards but earns 24,820 ₳/yr. An 11+ pool MPO absorbs 7.7% but earns 1,035,496 ₳/yr — 42× more at 6× less effective price | [Maintain and diversify a competitive delegator yield](../../../../README.md#33-maintain-and-diversify-a-competitive-delegator-yield) | The flat fee penalises small-pool delegators without compensating small-pool operators |
| OPE.O6.F2 | MPO revenue scales horizontally (more pools) not vertically (higher price). The 11+ pool bracket captures 26.5% of retail rewards through 7 entities | [Maintain and diversify a competitive delegator yield](../../../../README.md#33-maintain-and-diversify-a-competitive-delegator-yield) | Fleet size, not pricing, drives operator economics |
| OPE.O6.F3 | 57 hollow MPOs operate on 64.4% of retail rewards; 414 hollow single-pool operators share 31.1%; 41 balanced operators share 1.2% | [Maintain and diversify a competitive delegator yield](../../../../README.md#33-maintain-and-diversify-a-competitive-delegator-yield) | Structural concentration |
| OPE.O6.F4 | No single-pool operator in the retail market earns a competitive wage for their labour. The median single-pool revenue of ~25,000 ₳/yr ($6,250 at $0.25/ADA) covers infrastructure but not the 5–15 hrs/month of skilled work. Competitive compensation begins at the 2-pool MPO tier (~68,700 ₳/yr) | [Reduce the concentration effects that distort both populations](../../../../README.md#34-reduce-the-concentration-effects-that-distort-both-populations) | The single-pool operator subsidises the network |
...
| OPE.O7.F1 | 65.9% of retail delegators sit in hollow MPO pools at 2.18% net return; hollow single-pool near-saturation pools offer 2.34% — 0.16pp more — and hold 2.7% of delegators | [Maintain and diversify a competitive delegator yield](../../../../README.md#33-maintain-and-diversify-a-competitive-delegator-yield) | The return signal does not drive delegation |
| OPE.O7.F2 | The pledge premium is negative in the retail data: balanced median net return 1.98% vs hollow 2.08%. The flat fee drag (1.06pp for balanced vs 0.47pp for hollow single-pool operators) overwhelms the pledge benefit | [Maintain and diversify a competitive delegator yield](../../../../README.md#33-maintain-and-diversify-a-competitive-delegator-yield) | The incentive mechanism's core assumption fails |
| | **OPE.O8 — The mechanism is on a structural clock: reserve depletion compresses yield, widens the confiscatory zone, and erodes the signal every epoch** | | Reserve depletion is a structural clock — yield has fallen **5.3% → 2.0%** in **413 epochs** ($R^2 = 0.99$), projected to sub-**1.5%** within **~1.7 years**. As the epoch pot shrinks, the fixed-in-₳ flat fee consumes a growing share, the confiscatory zone expands upward, and the retail yield spread compresses toward block-production noise. |
...
| OPE.O8.F3 | As the epoch pot shrinks, the flat fee (fixed at 170/340 ₳) consumes a growing share of pool rewards — the confiscatory zone identified in [Constitutional framework](../../../../README.md#2-constitutional-framework) expands upward. The 0.39pp retail yield spread compresses proportionally: at 1.0% base yield (~3.5 years), the same relative dispersion produces ~0.20pp — indistinguishable from block-production noise. Pools that are viable today will cross the sub-viable threshold | [The yield spread — structural compression](#53-the-yield-spread-structural-compression) | The failures documented in §4 are not static — they degrade every epoch |
...
**Scope note.** OPE.O1 describes the flat fee channel ([Constitutional framework](../../../../README.md#2-constitutional-framework)). OPE.O2 describes the commission channel ([Guarantee operator viability across the entire productive population](../../../../README.md#31-guarantee-operator-viability-across-the-entire-productive-population)). OPE.O3 establishes the custodial/retail boundary and custodial economics ([Restore the notion of pledge among operators](../../../../README.md#32-restore-the-notion-of-pledge-among-operators)). OPE.O4–OPE.O6 characterise the retail market economics and operator viability ([Maintain and diversify a competitive delegator yield](../../../../README.md#33-maintain-and-diversify-a-competitive-delegator-yield)–4.5). OPE.O7 addresses delegation behaviour ([Maintain and diversify a competitive delegator yield](../../../../README.md#33-maintain-and-diversify-a-competitive-delegator-yield)). OPE.O8 places the mechanism on its temporal trajectory: the yield decline is not a separate problem — it amplifies every structural failure documented in §4 (§5).
...
67,817 delegations (5.2% of productive) sit in sub-viable pools where the flat fee's regressive geometry erodes most or all delegator returns — 92% of those land in independent single-pool operators. The **1,227,281 delegations** in viable pools are where the pricing plan produces meaningful outcomes. The downstream analysis ([Restore the notion of pledge among operators](../../../../README.md#32-restore-the-notion-of-pledge-among-operators)) decomposes the productive population into operator self-stake, custodial, and retail segments.
...
Not all staked ADA is delegated by independent participants choosing a pool on the open market. A significant share is **custodial** — controlled by operators rather than by the on-chain delegators themselves. Identifying these pools is necessary before the profitability analysis ([Maintain and diversify a competitive delegator yield](../../../../README.md#33-maintain-and-diversify-a-competitive-delegator-yield)) can isolate the genuine pricing market.
...
[Maintain and diversify a competitive delegator yield](../../../../README.md#33-maintain-and-diversify-a-competitive-delegator-yield) quantifies **what operators earn**; this section asks whether those earnings are **competitive** — whether they compensate for the real resources consumed.
...
Infrastructure and labour are denominated in fiat; operator revenue is denominated in ADA. The economic viability of pool operation is therefore a function of two variables: the ₳ revenue (set by the mechanism) and the ADA/USD exchange rate (set by the market). The [Maintain and diversify a competitive delegator yield](../../../../README.md#33-maintain-and-diversify-a-competitive-delegator-yield) revenue data maps directly onto this cost framework. The table below holds the first constant — each tier's median ₳/yr from [Maintain and diversify a competitive delegator yield](../../../../README.md#33-maintain-and-diversify-a-competitive-delegator-yield) — and varies the second across five price points spanning a 40× range.

| Operator tier | Revenue (₳/yr) | @$0.25 | @$0.50 | @$1.00 | @$5.00 | @$10.00 |
|---|---:|---:|---:|---:|---:|---:|
| Sub-viable single-pool | 24,820 | $6,205 | $12,410 | $24,820 | $124,100 | $248,200 |
...
The more important question for the delegator is not the absolute level but the **spread** — how much yield varies across the pools available for delegation. [Maintain and diversify a competitive delegator yield](../../../../README.md#33-maintain-and-diversify-a-competitive-delegator-yield) established that net ROS ranges from **1.95% to 2.34%** across the entire retail market — a **0.39 percentage-point spread**. This section places that spread in the context of the declining trajectory.

The spread is narrow because the reward curve distributes rewards **roughly proportional to stake**:

- The flat fee hyperbola penalises only small pools ([Constitutional framework](../../../../README.md#2-constitutional-framework));
- Commission competition has compressed fees in the large-pool regime ([Guarantee operator viability across the entire productive population](../../../../README.md#31-guarantee-operator-viability-across-the-entire-productive-population));
- Block production is proportional to stake;
- The single-pool/MPO distinction has no net yield effect ([Maintain and diversify a competitive delegator yield](../../../../README.md#33-maintain-and-diversify-a-competitive-delegator-yield)).
...
> **Finding OPE.O8.F3 — The failures documented in §4 are not static — they degrade every epoch.** As the epoch pot shrinks, the flat fee (fixed at 170/340 ₳) consumes a growing share of pool rewards — the confiscatory zone identified in [Constitutional framework](../../../../README.md#2-constitutional-framework) expands upward into currently viable tiers. The 0.39pp retail yield spread compresses proportionally: at 1.0% base yield (~3.5 years), the same relative dispersion produces ~0.20pp — indistinguishable from block-production noise. The mechanism was designed for a yield regime that no longer exists and will not return without protocol-level intervention.

The combined effect is a selection pressure that operates **asymmetrically** across the operator population. Each epoch the yield surface descends, the confiscatory zone of the flat fee hyperbola extends upward ([Constitutional framework](../../../../README.md#2-constitutional-framework)), and the viable-pool threshold rises.
...
The mechanism therefore produces a **ratchet**: as yield declines, the population of sub-viable single-pool operators grows, their delegators migrate to larger fleets, and the concentration documented in [Restore the notion of pledge among operators](../../../../README.md#32-restore-the-notion-of-pledge-among-operators) deepens.
