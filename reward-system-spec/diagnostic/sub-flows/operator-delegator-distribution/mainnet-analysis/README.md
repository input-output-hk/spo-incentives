...
| --- | --- | --- | --- |
| | **OPE.O1 — The flat fee dominates operator revenue but operators do not actively set it** | | |
...
| OPE.O1.F4 | The flat fee follows a $1/\sigma$ hyperbola: 47.5% of pool reward at the sub-viable tier, 1.5% at near-saturation. No other major PoS protocol uses a flat fee | [§1](../../../README.md#1-constitutional-framework) | Unique to Cardano — regressive by design |
| | **OPE.O2 — The commission market is bimodal with an empty middle** | | |
...
| | **OPE.O3 — 21% of productive stake is custodial — three mechanisms, three economics** | | |
...
| | **OPE.O4 — The retail market is 79% of stake and the typical delegator holds 87 ₳** | | |
...
| | **OPE.O5 — Delegators pay 18× more for the same return** | | |
...
| | **OPE.O6 — Stake pool operator profitability ranges from 24K to 1M ₳/yr — operators who charge the most earn the least** | | |
...
| | **OPE.O7 — Delegation follows visibility, not return** | | |
...
| | **OPE.O8 — The mechanism is on a structural clock: reserve depletion compresses yield, widens the confiscatory zone, and erodes the signal every epoch** | | |
