...
| F1.1 | The flat fee accounts for 60% of all operator revenue in the retail market; the commission accounts for 40% | [§2.3](../../../README.md#23-maintain-and-diversify-a-competitive-delegator-yield) | Structural — the passive channel dominates the active one |
| F1.2 | 64% of pools still declare the former floor (340 ₳) — 178 epochs after a governance action halved it to 170 ₳ | [§1](../../../README.md#1-constitutional-framework) | Governance inertia — driven by the largest entities |
| F1.3 | 89.5% of pools declare one of two floor values (170 or 340 ₳); "custom" values are mostly near-floor inertia (Binance 345, Everstake 400) or extraction | [§1](../../../README.md#1-constitutional-framework) | The flat fee is a binary choice, not a pricing parameter |
| F1.4 | The flat fee follows a $1/\sigma$ hyperbola: 47.5% of pool reward at the sub-viable tier, 1.5% at near-saturation. No other major PoS protocol uses a flat fee | [§1](../../../README.md#1-constitutional-framework) | Unique to Cardano — regressive by design |
| | **O2 — The commission market is bimodal with an empty middle** | | |
| F2.1 | 87% of pools set a commission at or below 10%; 12% set ≥ 99% (privatisation). The 89pp range between 10% and 99% contains 12 pools | [§2.1](../../../README.md#21-guarantee-operator-viability-across-the-entire-productive-population) | No man's land — no economic attractor exists between pricing and extraction |
| F2.2 | Four bands: no-commission (170 pools, 17.9%), competitive (658, 69.1%), no man's land (12, 1.3%), privatisation (112, 11.8%) | [§2.1](../../../README.md#21-guarantee-operator-viability-across-the-entire-productive-population) | The market self-organises into discrete tiers |
| | **O3 — 21% of productive stake is custodial — three mechanisms, three economics** | | |
| F3.1 | 79 entities operating 143 pools (4.55B, 21.1%) are custodial: by pledge (10 entities, 36 pools, 1.59B), by extraction (57 entities, 79 pools, 2.04B), by delegation (15 entities, 28 pools, 0.92B) | [§2.2](../../../README.md#22-restore-the-notion-of-pledge-among-operators) | Three distinct mechanisms — each detectable from on-chain observables |
| F3.2 | Custodial-by-delegation uses the per-pool **median** delegation (db-sync `epoch_stake`) ≥ 100K ₳ — the amount held by the typical delegator. A delegation of 50K ₳ is already in the top 1.5% of the network | [§2.2.2](../../../README.md#222-specification) | The median measures the delegator's experience, not capital concentration |
...
| F4.2 | The median retail delegation is 87 ₳ — remarkably uniform across operator types (45–962 ₳ range) | [§2.3](../../../README.md#23-maintain-and-diversify-a-competitive-delegator-yield) | Retail delegators are small and homogeneous |
...
| F5.2 | Net return converges to 1.95–2.34% across the entire retail market regardless of effective price, operator type, or pool size | [§2.3](../../../README.md#23-maintain-and-diversify-a-competitive-delegator-yield) | The return signal is too weak to drive delegation |
...
| F6.2 | MPO revenue scales horizontally (more pools) not vertically (higher price). The 11+ pool bracket captures 26.5% of retail rewards through 7 entities | [§2.3](../../../README.md#23-maintain-and-diversify-a-competitive-delegator-yield) | Fleet size, not pricing, drives operator economics |
| F6.3 | 57 hollow MPOs operate on 64.4% of retail rewards; 414 hollow single-pool operators share 31.1%; 41 balanced operators share 1.2% | [§2.3](../../../README.md#23-maintain-and-diversify-a-competitive-delegator-yield) | Structural concentration |
...
| F7.1 | 65.9% of retail delegators sit in hollow MPO pools at 2.18% net return; hollow single-pool near-saturation pools offer 2.34% — 0.16pp more — and hold 2.7% of delegators | [§2.3](../../../README.md#23-maintain-and-diversify-a-competitive-delegator-yield) | The return signal does not drive delegation |
...
**Scope note.** O1 describes the flat fee channel ([§1](../../../README.md#1-constitutional-framework)). O2 describes the commission channel ([§2.1](../../../README.md#21-guarantee-operator-viability-across-the-entire-productive-population)). O3 establishes the custodial/retail boundary and custodial economics ([§2.2](../../../README.md#22-restore-the-notion-of-pledge-among-operators)). O4–O6 characterise the retail market economics and operator viability ([§2.3](../../../README.md#23-maintain-and-diversify-a-competitive-delegator-yield)–4.5). O7 addresses delegation behaviour ([§2.3](../../../README.md#23-maintain-and-diversify-a-competitive-delegator-yield)). O8 places the mechanism on its temporal trajectory: the yield decline is not a separate problem — it amplifies every structural failure documented in §4 (§5).
