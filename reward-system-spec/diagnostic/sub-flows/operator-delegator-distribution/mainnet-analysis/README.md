...
| OPE.O1.F1 | The flat fee accounts for **60%** of all operator revenue in the retail market; the commission accounts for **40%** | [§2.3](../../../README.md#23-maintain-and-diversify-a-competitive-delegator-yield) | Structural — the passive channel dominates the active one |
| OPE.O1.F2 | **64%** of pools still declare the former floor (**340 ₳**) — **178 epochs** after a governance action halved it to **170 ₳** | [§1](../../../README.md#1-constitutional-framework) | Governance inertia — driven by the largest entities |
| OPE.O1.F3 | **89.5%** of pools declare one of two floor values (**170** or **340 ₳**); "custom" values are mostly near-floor inertia (Binance 345, Everstake 400) or extraction | [§1](../../../README.md#1-constitutional-framework) | The flat fee is a binary choice, not a pricing parameter |
| OPE.O1.F4 | The flat fee follows a $1/\sigma$ hyperbola: **47.5%** of pool reward at the sub-viable tier, **1.5%** at near-saturation | [§1](../../../README.md#1-constitutional-framework) | Regressive by design — a fixed-in-₳ levy on a size-proportional reward |
| OPE.O1.F5 | **No other major PoS protocol uses a flat fee.** The fixed-cost model is unique to Cardano; Ethereum, Solana, Cosmos, and Polkadot all price validators on proportional rules | [§1](../../../README.md#1-constitutional-framework) | Unique to Cardano — no cross-chain precedent or comparator |
...
| OPE.O2.F1 | 87% of pools set a commission at or below 10%; 12% set ≥ 99% (privatisation). The 89pp range between 10% and 99% contains 12 pools | [§2.1](../../../README.md#21-guarantee-operator-viability-across-the-entire-productive-population) | No man's land — no economic attractor exists between pricing and extraction |
| OPE.O2.F2 | Four bands: no-commission (170 pools, 17.9%), competitive (658, 69.1%), no man's land (12, 1.3%), privatisation (112, 11.8%) | [§2.1](../../../README.md#21-guarantee-operator-viability-across-the-entire-productive-population) | The market self-organises into discrete tiers |
...
| OPE.O3.F1 | 79 entities operating 143 pools (4.55B, 21.1%) are custodial: by pledge (10 entities, 36 pools, 1.59B), by extraction (57 entities, 79 pools, 2.04B), by delegation (15 entities, 28 pools, 0.92B) | [§2.2](../../../README.md#22-restore-the-notion-of-pledge-among-operators) | Three distinct mechanisms — each detectable from on-chain observables |
| OPE.O3.F2 | Custodial-by-delegation uses the per-pool **median** delegation (db-sync `epoch_stake`) ≥ 100K ₳ — the amount held by the typical delegator. A delegation of 50K ₳ is already in the top 1.5% of the network | [§2.2.2](../../../README.md#222-specification) | The median measures the delegator's experience, not capital concentration |
...
| OPE.O4.F1 | 809 retail pools, 516 entities, 17.02B ADA, 1,272,836 delegators. This includes institutional operators (Coinbase, Binance, Kiln) — retail by median delegation | [§4.3.3](#433-summary) | The retail market is larger than the mean-based estimate suggested |
| OPE.O4.F2 | The median retail delegation is 87 ₳ — remarkably uniform across operator types (45–962 ₳ range) | [§2.3](../../../README.md#23-maintain-and-diversify-a-competitive-delegator-yield) | Retail delegators are small and homogeneous |
...
| OPE.O5.F1 | A delegator in a sub-viable pool pays 48.3% effective price and receives 2.04% net return. A delegator in a near-saturation pool pays 2.7% and receives 2.34%. 18× more for 0.30pp of return | [§2.3](../../../README.md#23-maintain-and-diversify-a-competitive-delegator-yield) | The effective price is a mechanical artefact of pool size, not a market signal |
| OPE.O5.F2 | Net return converges to 1.95–2.34% across the entire retail market regardless of effective price, operator type, or pool size | [§2.3](../../../README.md#23-maintain-and-diversify-a-competitive-delegator-yield) | The return signal is too weak to drive delegation |
...
| OPE.O6.F1 | A sub-viable single-pool operator absorbs 48.3% of pool rewards but earns 24,820 ₳/yr. An 11+ pool MPO absorbs 7.7% but earns 1,035,496 ₳/yr — 42× more at 6× less effective price | [§2.3](../../../README.md#23-maintain-and-diversify-a-competitive-delegator-yield) | The flat fee penalises small-pool delegators without compensating small-pool operators |
| OPE.O6.F2 | MPO revenue scales horizontally (more pools) not vertically (higher price). The 11+ pool bracket captures 26.5% of retail rewards through 7 entities | [§2.3](../../../README.md#23-maintain-and-diversify-a-competitive-delegator-yield) | Fleet size, not pricing, drives operator economics |
| OPE.O6.F3 | 57 hollow MPOs operate on 64.4% of retail rewards; 414 hollow single-pool operators share 31.1%; 41 balanced operators share 1.2% | [§2.3](../../../README.md#23-maintain-and-diversify-a-competitive-delegator-yield) | Structural concentration |
| OPE.O6.F4 | No single-pool operator in the retail market earns a competitive wage for their labour. The median single-pool revenue of ~25,000 ₳/yr ($6,250 at $0.25/ADA) covers infrastructure but not the 5–15 hrs/month of skilled work. Competitive compensation begins at the 2-pool MPO tier (~68,700 ₳/yr) | [§2.4](../../../README.md#24-reduce-the-concentration-effects-that-distort-both-populations) | The single-pool operator subsidises the network |
...
| OPE.O7.F1 | 65.9% of retail delegators sit in hollow MPO pools at 2.18% net return; hollow single-pool near-saturation pools offer 2.34% — 0.16pp more — and hold 2.7% of delegators | [§2.3](../../../README.md#23-maintain-and-diversify-a-competitive-delegator-yield) | The return signal does not drive delegation |
| OPE.O7.F2 | The pledge premium is negative in the retail data: balanced median net return 1.98% vs hollow 2.08%. The flat fee drag (1.06pp for balanced vs 0.47pp for hollow single-pool operators) overwhelms the pledge benefit | [§2.3](../../../README.md#23-maintain-and-diversify-a-competitive-delegator-yield) | The incentive mechanism's core assumption fails |
...
**Scope note.** OPE.O1 describes the flat fee channel ([§1](../../../README.md#1-constitutional-framework)). OPE.O2 describes the commission channel ([§2.1](../../../README.md#21-guarantee-operator-viability-across-the-entire-productive-population)). OPE.O3 establishes the custodial/retail boundary and custodial economics ([§2.2](../../../README.md#22-restore-the-notion-of-pledge-among-operators)). OPE.O4–OPE.O6 characterise the retail market economics and operator viability ([§2.3](../../../README.md#23-maintain-and-diversify-a-competitive-delegator-yield)–4.5). OPE.O7 addresses delegation behaviour ([§2.3](../../../README.md#23-maintain-and-diversify-a-competitive-delegator-yield)). OPE.O8 places the mechanism on its temporal trajectory: the yield decline is not a separate problem — it amplifies every structural failure documented in §4 (§5).
...
67,817 delegations (5.2% of productive) sit in sub-viable pools where the flat fee's regressive geometry erodes most or all delegator returns — 92% of those land in independent single-pool operators. The **1,227,281 delegations** in viable pools are where the pricing plan produces meaningful outcomes. The downstream analysis ([§2.2](../../../README.md#22-restore-the-notion-of-pledge-among-operators)) decomposes the productive population into operator self-stake, custodial, and retail segments.
