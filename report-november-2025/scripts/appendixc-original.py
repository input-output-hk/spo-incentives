...
#                              -- CONFIGURATION --
# ==============================================================================
INPUT_CSV_FILE = 'analysis_results_filtered.csv'
...
def analyze_data(file_path):
    ...
    if not all_valid_case_studies:
        ...
        print(f"\nFound and displaying all {len(all_valid_case_studies)} valid comparison groups across all epochs:\n")

        for study in all_valid_case_studies:
            print(f"--- Case Study: {study['num_pools']} pools produced {study['blocks']} blocks in Epoch {study['epoch']} ---")
            ...
            print(f"  -> Analysis: The highest pledge pool earned {reward_diff:,.2f} ADA more than the lowest pledge pool.")
            print("-" * 40 + "\n")
