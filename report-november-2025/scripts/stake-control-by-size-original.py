...
ABANDONED_POOLS_SOURCE_FILE = 'appendixA.txt' # Text file with the list of abandoned pools
...
def plot_stake_control_chart_filtered():
    ...
    try:
        ...
        max_epoch = pd.read_sql("SELECT MAX(no) FROM epoch", engine).iloc[0,0]
        ...
        output_filename = 'stake_control_by_size_parallel_filter.png'
