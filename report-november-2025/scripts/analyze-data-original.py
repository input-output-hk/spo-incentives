...
def generate_png_plots(csv_path='all_epochs_summary.csv'):
    ...
    sns.despine()
    plt.savefig('pool_count_epoch.png', bbox_inches='tight', dpi=300)
    plt.close()
    print("  - Saved 'pool_count_epoch.png'")
    ...
    sns.despine()
    plt.savefig('stake_percentage_epoch.png', bbox_inches='tight', dpi=300)
    plt.close()
    print("  - Saved 'stake_percentage_epoch.png'")
    ...
    plt.legend()
    sns.despine()
    plt.savefig('stake_distribution_epoch.png', bbox_inches='tight', dpi=300)
    plt.close()
    print("  - Saved 'stake_distribution_epoch.png'")
    ...
    sns.despine()
    plt.savefig('block_production_health.png', bbox_inches='tight', dpi=300)
    plt.close()
    print("  - Saved 'block_production_health.png'")
    ...
    plt.gca().yaxis.set_major_formatter(plt.FuncFormatter(lambda y, _: f'{y:.1f}%'))
    sns.despine()
    plt.savefig('active_stake_participation.png', bbox_inches='tight', dpi=300)
    plt.close()
    print("  - Saved 'active_stake_participation.png'")
