...
latest_pool_update AS (
    -- Pin: filter pool_update to txs in epochs <= 586 so MPO groupings
    -- (by ticker / DNS / reward_addr) reflect db-sync state at report time.
...
def main():
    ...
    try:
        ...
        plot_evolution_data(
            ...
            "mpo_evolution_pct_circulating-pinned.png"
        )
        ...
        plot_evolution_data(
            ...
            "mpo_evolution_pct_delegated-pinned.png"
        )
